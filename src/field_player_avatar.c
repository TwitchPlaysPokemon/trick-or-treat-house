...
{
    {EVENT_OBJ_GFX_BRENDAN_NORMAL,     EVENT_OBJ_GFX_MAY_NORMAL,     EVENT_OBJ_GFX_TREEKID_NORMAL},
    {EVENT_OBJ_GFX_BRENDAN_MACH_BIKE,  EVENT_OBJ_GFX_MAY_MACH_BIKE,  EVENT_OBJ_GFX_TREEKID_MACH_BIKE},
    {EVENT_OBJ_GFX_BRENDAN_ACRO_BIKE,  EVENT_OBJ_GFX_MAY_ACRO_BIKE,  EVENT_OBJ_GFX_TREEKID_ACRO_BIKE},
    {EVENT_OBJ_GFX_BRENDAN_SURFING,    EVENT_OBJ_GFX_MAY_SURFING,    EVENT_OBJ_GFX_TREEKID_SURFING},
    {EVENT_OBJ_GFX_BRENDAN_UNDERWATER, EVENT_OBJ_GFX_MAY_UNDERWATER, EVENT_OBJ_GFX_TREEKID_UNDERWATER},
    {EVENT_OBJ_GFX_BRENDAN_FIELD_MOVE, EVENT_OBJ_GFX_MAY_FIELD_MOVE, EVENT_OBJ_GFX_TREEKID_FIELD_MOVE},
    {EVENT_OBJ_GFX_BRENDAN_FISHING,    EVENT_OBJ_GFX_MAY_FISHING,    EVENT_OBJ_GFX_TREEKID_FISHING},
    {EVENT_OBJ_GFX_BRENDAN_WATERING,   EVENT_OBJ_GFX_MAY_WATERING,   EVENT_OBJ_GFX_TREEKID_WATERING},
};

static const u8 sFRLGAvatarGfxIds[] = {EVENT_OBJ_GFX_RED, EVENT_OBJ_GFX_LEAF};

static const u8 sRSAvatarGfxIds[] = {EVENT_OBJ_GFX_BRENDAN_NORMAL, EVENT_OBJ_GFX_MAY_NORMAL};

static const u8 gUnknown_0849750C[3][5][2] =
{
    //male
    {
    ...
    //nonbinary
    {
        {EVENT_OBJ_GFX_TREEKID_NORMAL, 1},
        {EVENT_OBJ_GFX_TREEKID_MACH_BIKE, 2},
        {EVENT_OBJ_GFX_TREEKID_ACRO_BIKE, 4},
        {EVENT_OBJ_GFX_TREEKID_SURFING, 8},
        {EVENT_OBJ_GFX_TREEKID_UNDERWATER, 16},
    },
};
...
void SetPlayerAvatarExtraStateTransition(u16 graphicsId, u8 b)
{
