...
const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TEAM_AQUA] = _(COSTUME_NAME("SEXY AQUA","TEAM AQUA")),
    [TRAINER_CLASS_PKMN_BREEDER] = _(COSTUME_NAME("SUPERHERO", "{PKMN} BREEDER")),
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = _(COSTUME_NAME("SEXY MAGMA", "TEAM MAGMA")),
    ...
    [TRAINER_CLASS_POKEMANIAC] = _(COSTUME_NAME("COSPLAYER", "POKéMANIAC")),
    ...
    [TRAINER_CLASS_BUG_MANIAC] = _(COSTUME_NAME("BURGLAR","BUG MANIAC")),
    ...
    [TRAINER_CLASS_DRAGON_TAMER] = _(COSTUME_NAME("SUPERVILLIAN", "DRAGON TAMER")),
    ...
    [TRAINER_CLASS_PLASMA_KID] = _("PLASMA KID"),
    [TRAINER_CLASS_GHETSIS] = _("“GHETSIS”"),
    [TRAINER_CLASS_FROGGER] = _("POLITOED"),
    [TRAINER_CLASS_MERMAID] = _("MERMAID"),
    [TRAINER_CLASS_MASKED_BOY] = _("MASKED BOY"),
    [TRAINER_CLASS_FAIRY_GIRL] = _("FAIRY GIRL"),
    [TRAINER_CLASS_CORPSE_BRIDE] = _("CORPSE BRIDE"),
    [TRAINER_CLASS_HERO_OF_TIME] = _("HERO OF TIME"),
    [TRAINER_CLASS_SKELETON] = _("SKELETON"),
    [TRAINER_CLASS_TARZAN] = _("JUNGLE MAN"),
