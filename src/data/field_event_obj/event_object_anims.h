...
const union AnimCmd gEventObjectImageAnim_DoorClosed[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_JUMP(0),
};

const union AnimCmd gEventObjectImageAnim_DoorOpen[] =
{
    ANIMCMD_FRAME(3, 1),
    ANIMCMD_JUMP(0),
};
...
const union AnimCmd *const gEventObjectImageAnimTable_TrickDoor[] = {
