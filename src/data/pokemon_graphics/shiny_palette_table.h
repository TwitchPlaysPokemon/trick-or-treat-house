const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(MIMIKYU, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(GOURGEIST, gMonShinyPalette_DoubleQuestionMark),
    SPECIES_SHINY_PAL(SLURPUFF, gMonShinyPalette_DoubleQuestionMark),
