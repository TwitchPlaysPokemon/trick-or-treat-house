const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(MIMIKYU, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(GOURGEIST, gMonFrontPic_DoubleQuestionMark),
    SPECIES_SPRITE(SLURPUFF, gMonFrontPic_DoubleQuestionMark),
