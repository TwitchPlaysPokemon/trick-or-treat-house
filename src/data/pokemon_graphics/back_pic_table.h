const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(MIMIKYU, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(GOURGEIST, gMonBackPic_DoubleQuestionMark),
    SPECIES_SPRITE(SLURPUFF, gMonBackPic_DoubleQuestionMark),
