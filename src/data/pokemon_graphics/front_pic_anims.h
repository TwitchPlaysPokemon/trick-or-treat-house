...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    ANIM_CMD(CELEBI),
    ANIM_CMD(MIMIKYU),
    ANIM_CMD_FULL(GOURGEIST, sAnims_MIMIKYU),
    ANIM_CMD_FULL(SLURPUFF, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_E, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_F, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_G, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_H, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_I, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_J, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_K, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_L, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_M, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_N, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_O, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_P, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_Q, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_R, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_S, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_T, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_U, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_V, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_W, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_X, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_Y, sAnims_MIMIKYU),
    ANIM_CMD_FULL(OLD_UNOWN_Z, sAnims_MIMIKYU),
    ANIM_CMD(TREECKO),
    ANIM_CMD(GROVYLE),
    ANIM_CMD(SCEPTILE),
    ANIM_CMD(TORCHIC),
