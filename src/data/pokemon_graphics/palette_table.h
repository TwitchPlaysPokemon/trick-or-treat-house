const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(MIMIKYU, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(GOURGEIST, gMonPalette_DoubleQuestionMark),
    SPECIES_PAL(SLURPUFF, gMonPalette_DoubleQuestionMark),
