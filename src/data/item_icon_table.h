#if USE_CANDY_NAMES
#define CANDY_ICON(candy, normalpic, normalpal) {gItemIconPic_##candy, gItemIconPal_##candy}
#else
#define CANDY_ICON(candy, normalpic, normalpal) {gItemIcon_##normalpic, gItemIconPalette_##normalpal}
#endif
...
const u32 *const gItemIconTable[][2] =
{
    ...
    // Medicine
    [ITEM_POTION] =         CANDY_ICON(chocobar, Potion, Potion),
    [ITEM_ANTIDOTE] =       CANDY_ICON(starburst, Antidote, Antidote),
    [ITEM_BURN_HEAL] =      CANDY_ICON(lemondrop, StatusHeal, BurnHeal),
    [ITEM_ICE_HEAL] =       CANDY_ICON(warhead, StatusHeal, IceHeal),
    [ITEM_AWAKENING] =      CANDY_ICON(pretzel, StatusHeal, Awakening),
    [ITEM_PARALYZE_HEAL] =  CANDY_ICON(veromango, StatusHeal, ParalyzeHeal),
    [ITEM_FULL_RESTORE] =   CANDY_ICON(100grand, LargePotion, FullRestore),
    [ITEM_MAX_POTION] =     CANDY_ICON(whitechoco, LargePotion, MaxPotion),
    [ITEM_HYPER_POTION] =   CANDY_ICON(butterfinger, Potion, HyperPotion),
    [ITEM_SUPER_POTION] =   CANDY_ICON(twix, Potion, SuperPotion),
    [ITEM_FULL_HEAL] =      CANDY_ICON(reesecup, FullHeal, FullHeal),
    ...
    [ITEM_ENERGY_POWDER] =  CANDY_ICON(carrotstick, Powder, EnergyPowder),
    [ITEM_ENERGY_ROOT] =    CANDY_ICON(appleslice, EnergyRoot, EnergyRoot),
    [ITEM_HEAL_POWDER] =    CANDY_ICON(prune, Powder, HealPowder),
    [ITEM_REVIVAL_HERB] =   CANDY_ICON(celerystick, RevivalHerb, RevivalHerb),
    [ITEM_ETHER] =          CANDY_ICON(malteser, Ether, Ether),
    [ITEM_MAX_ETHER] =      CANDY_ICON(cadbury, Ether, MaxEther),
    [ITEM_ELIXIR] =         CANDY_ICON(snowball, Ether, Elixir),
    [ITEM_MAX_ELIXIR] =     CANDY_ICON(turkish, Ether, MaxElixir),
    [ITEM_LAVA_COOKIE] =    CANDY_ICON(oreo, LavaCookie, LavaCookieAndLetter),
    ...
    // ????????
    [ITEM_CANDY_ABUNDANT] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_COMMON] =   {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_UNCOMMON] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_RARE] =     {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_HEALTHY] =  {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    ...
    // Valuables
    [ITEM_TINY_MUSHROOM] =  CANDY_ICON(mmmini, TinyMushroom, Mushroom),
    [ITEM_BIG_MUSHROOM] =   CANDY_ICON(mmjumbo, BigMushroom, Mushroom),
    [ITEM_069] =            {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_PEARL] =          CANDY_ICON(gobstopper, Pearl, Pearl),
    [ITEM_BIG_PEARL] =      CANDY_ICON(xlchoco, BigPearl, Pearl),
    [ITEM_STARDUST] =       CANDY_ICON(pixiestick, Stardust, Star),
    [ITEM_STAR_PIECE] =     CANDY_ICON(fererorocher, StarPiece, Star),
    [ITEM_NUGGET] =         CANDY_ICON(toblerone, Nugget, Nugget),
    [ITEM_HEART_SCALE] =    CANDY_ICON(gummybear, HeartScale, HeartScale),
    // ????????
    ...
    [ITEM_STRENGTH_ITEM] =  {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_SURF_ITEM] =  {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_FLY_ITEM] =   {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    ...
    // TTH Candy
    [ITEM_CANDY_CHOCOLATE] =      {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_CHOCOWHITE] =     {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_CHOCOSLAB] =      {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_STARBURST] =      {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_LEMONDROP] =      {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_WARHEAD] =        {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_PRETZEL] =        {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_VEROMANGO] =      {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_VIOLETCRUMBLE] =  {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_TWIXLEFT] =       {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_TWIXRIGHT] =      {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_MMMINI] =         {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_MMPEANUT] =       {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_KINGCHOCNUT] =    {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_GUMMYBEAR] =      {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_REESES] =         {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_BUTTERFINGER] =   {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_MILKYWAY] =       {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_MILKALUFLEE] =    {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_100GRAND] =       {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_MALTESERS] =      {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_CADBURYCREME] =   {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_WUNDERBAR] =      {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_OREO] =           {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_COFFEECRISP] =    {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_SAMBOPRISTUR] =   {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_SNICKERS] =       {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_MARSBAR] =        {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_KITKAT] =         {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_PIXIESTICK] =     {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_TURKISHDELIGHT] = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_GOBSTOPPER] =     {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_BLACKTHUNDER] =   {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_TOBLERONE] =      {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_FERREROROCHER] =  {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_EGGS] =           {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_EGGDEVILED] =     {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_CARROT] =         {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_APPLE] =          {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_PRUNE] =          {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_CELERY] =         {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_SNAPPEAS] =       {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_RAISIN] =         {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_KALE] =           {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_CANDY_GALAXY] =         {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
