...
const u8 gText_TrickMaster[] = _("TRICK MASTER");
const u8 gText_TrickMasterShiny[] = _("{COLOR RED}T{COLOR GREEN}R{COLOR BLUE}I{COLOR RED}C{COLOR GREEN}K {COLOR BLUE}M{COLOR RED}A{COLOR GREEN}S{COLOR BLUE}T{COLOR RED}E{COLOR GREEN}R{COLOR DARK_GREY}");
