...
const u8 gExpandedPlaceholder_TrickMasterShiny[] = _("{COLOR RED}T{COLOR GREEN}R{COLOR BLUE}I{COLOR RED}C{COLOR GREEN}K {COLOR BLUE}M{COLOR RED}A{COLOR GREEN}S{COLOR BLUE}T{COLOR RED}E{COLOR GREEN}R{COLOR DARK_GREY}");
const u8 gExpandedPlaceholder_Youngster[] = _("Joey");
...
const u8 gExpandedPlaceholder_Boulder[] = _("boulder");
const u8 gExpandedPlaceholder_Crate[] = _("crate");
...
const u8 gText_BirchBoy[] = _("Mudkid"); //_("BOY");
const u8 gText_BirchGirl[] = _("Torchick"); //_("GIRL");
const u8 gText_BirchNb[] = _("Treekid"); //_("NONBINARY");
...
const u8 gText_DefaultNameJamie[] = _("Jamie");
const u8 gText_DefaultNameAlex[] = _("Alex");
const u8 gText_DefaultNameBlake[] = _("Blake");
const u8 gText_DefaultNameGale[] = _("Gale");
const u8 gText_DefaultNameKris[] = _("Kris");
const u8 gText_DefaultNameLex[] = _("Lex");
const u8 gText_DefaultNameNickey[] = _("Nickey");
const u8 gText_DefaultNameParker[] = _("Parker");
const u8 gText_DefaultNamePiper[] = _("Piper");
const u8 gText_DefaultNameOrian[] = _("Orian");
const u8 gText_DefaultNameQuinn[] = _("Quinn");
const u8 gText_DefaultNameSkylar[] = _("Skylar");
const u8 gText_DefaultNameTaylor[] = _("Taylor");
const u8 gText_DefaultNameTracy[] = _("Tracy");
const u8 gText_DefaultNameZane[] = _("Zane");
const u8 gText_DefaultNameAvery[] = _("Avery");
const u8 gText_DefaultNameJordan[] = _("Jordan");
const u8 gText_DefaultNameRiver[] = _("River");
const u8 gText_DefaultNameCharlie[] = _("Charlie");
const u8 gText_DefaultNameSawyer[] = _("Sawyer");

const u8 gText_DefaultNameJoel[] = _("Joel");
const u8 gText_DefaultNameAdele[] = _("Adele");
const u8 gText_DefaultNameLennie[] = _("Lennie");
const u8 gText_DefaultNameNatalie[] = _("Natalie");
const u8 gText_DefaultNameConley[] = _("Conley");
const u8 gText_DefaultNameCrystal[] = _("Crystal");
const u8 gText_DefaultNameJustin[] = _("Justin");
const u8 gText_DefaultNameMadelyn[] = _("Madelyn");
const u8 gText_DefaultNameHugo[] = _("Hugo");
const u8 gText_DefaultNameAmelia[] = _("Amelia");
const u8 gText_DefaultNameDiego[] = _("Diego");
const u8 gText_DefaultNameHanna[] = _("Hanna");
const u8 gText_DefaultNameDuncan[] = _("Duncan");
const u8 gText_DefaultNameOctavia[] = _("Octavia");
const u8 gText_DefaultNameJoey[] = _("Joey");
const u8 gText_DefaultNameCileste[] = _("Cileste");
const u8 gText_DefaultNameLogan[] = _("Logan");
const u8 gText_DefaultNameEdna[] = _("Edna");
const u8 gText_DefaultNameEvan[] = _("Evan");
const u8 gText_DefaultNameSierra[] = _("Sierra");

const u8 gText_StarterNameSparky[] = _("Sparky");
const u8 gText_StarterNameLeafy[] = _("Leafy");
const u8 gText_StarterNameBlitz[] = _("Blitz");
const u8 gText_StarterNameZipper[] = _("Zipper");
const u8 gText_StarterNameLycan[] = _("Lycan");
const u8 gText_StarterNameKenya[] = _("Kenya");
const u8 gText_StarterNameBilli[] = _("Billi");
const u8 gText_StarterNameSquirt[] = _("Squirt");
const u8 gText_StarterNameEthan[] = _("Ethan");
const u8 gText_StarterNameAce[] = _("Ace");
const u8 gText_StarterNameKamon[] = _("Kamon");
const u8 gText_StarterNameOrphen[] = _("Orphen");
const u8 gText_StarterNameTeddy[] = _("Teddy");
const u8 gText_StarterNameBugsy[] = _("Bugsy");
const u8 gText_StarterNameKetut[] = _("Ketut");
const u8 gText_StarterNameHardy[] = _("Hardy");
const u8 gText_StarterNameRin[] = _("Rin");
...
const u8 gText_ItemFinderNearby[] = _("Huh?\nThe ITEMFINDER's responding!\pThere's an item hidden around here!{PAUSE_UNTIL_PRESS}");
...
const u8 gBort_PlayerUsedVar2[] = _("{PLAYER} TIE WITH\n{STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_3MinutePlus[] = _("3 minute +");
const u8 gText_SpaceSeconds[] = _(" seconds");
const u8 gText_SpaceTimes[] = _(" time(s)");
const u8 gText_WayTooLong1[] = _("Way");
const u8 gText_WayTooLong2[] = _("too");
const u8 gText_WayTooLong3[] = _("long");
