...
extern const u8 TrickTreat_MossdeepCity_SpaceCenter_2F_EventScript_224157[];
extern const u8 TrickTreat_MossdeepCity_SpaceCenter_2F_EventScript_224166[];
...
void DoSpecialTrainerBattle(void)
{
    ...
    //     BattleSetup_ConfigureTrainerBattle(TrickTreat_MossdeepCity_SpaceCenter_2F_EventScript_224157 + 1);
    //     gApproachingTrainerId = 1;
    //     BattleSetup_ConfigureTrainerBattle(TrickTreat_MossdeepCity_SpaceCenter_2F_EventScript_224166 + 1);
