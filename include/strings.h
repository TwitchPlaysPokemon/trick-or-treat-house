...
extern const u8 gText_ConfirmEscape[];
...
extern const u8 gText_SaveFileOldTTH[];
...
extern const u8 gText_Birch_ControlKid[];
extern const u8 gText_Birch_ControlGirl[];
extern const u8 gText_Birch_SoItsPlayer[];
extern const u8 gText_Birch_YourePlayer[];
extern const u8 gText_Birch_RandomAsk[];
extern const u8 gText_Birch_RandomAnswerYes[];
extern const u8 gText_Birch_RandomAnswerNo[];
extern const u8 gText_Birch_RandomReplyYes[];
extern const u8 gText_Birch_RandomReplyNo[];
...
extern const u8 gText_DefaultNameJamie[];
extern const u8 gText_DefaultNameAlex[];
extern const u8 gText_DefaultNameBlake[];
extern const u8 gText_DefaultNameGale[];
extern const u8 gText_DefaultNameKris[];
extern const u8 gText_DefaultNameLex[];
extern const u8 gText_DefaultNameNickey[];
extern const u8 gText_DefaultNameParker[];
extern const u8 gText_DefaultNamePiper[];
extern const u8 gText_DefaultNameOrian[];
extern const u8 gText_DefaultNameQuinn[];
extern const u8 gText_DefaultNameSkylar[];
extern const u8 gText_DefaultNameTaylor[];
extern const u8 gText_DefaultNameTracy[];
extern const u8 gText_DefaultNameZane[];
extern const u8 gText_DefaultNameAvery[];
extern const u8 gText_DefaultNameJordan[];
extern const u8 gText_DefaultNameRiver[];
extern const u8 gText_DefaultNameCharlie[];
extern const u8 gText_DefaultNameSawyer[];
extern const u8 gText_DefaultNameJoel[];
extern const u8 gText_DefaultNameAdele[];
extern const u8 gText_DefaultNameLennie[];
extern const u8 gText_DefaultNameNatalie[];
extern const u8 gText_DefaultNameConley[];
extern const u8 gText_DefaultNameCrystal[];
extern const u8 gText_DefaultNameJustin[];
extern const u8 gText_DefaultNameMadelyn[];
extern const u8 gText_DefaultNameHugo[];
extern const u8 gText_DefaultNameAmelia[];
extern const u8 gText_DefaultNameDiego[];
extern const u8 gText_DefaultNameHanna[];
extern const u8 gText_DefaultNameDuncan[];
extern const u8 gText_DefaultNameOctavia[];
extern const u8 gText_DefaultNameJoey[];
extern const u8 gText_DefaultNameCileste[];
extern const u8 gText_DefaultNameLogan[];
extern const u8 gText_DefaultNameEdna[];
extern const u8 gText_DefaultNameEvan[];
extern const u8 gText_DefaultNameSierra[];
extern const u8 gText_StarterNameSparky[];
extern const u8 gText_StarterNameLeafy[];
extern const u8 gText_StarterNameBlitz[];
extern const u8 gText_StarterNameZipper[];
extern const u8 gText_StarterNameLycan[];
extern const u8 gText_StarterNameKenya[];
extern const u8 gText_StarterNameBilli[];
extern const u8 gText_StarterNameSquirt[];
extern const u8 gText_StarterNameEthan[];
extern const u8 gText_StarterNameAce[];
extern const u8 gText_StarterNameKamon[];
extern const u8 gText_StarterNameOrphen[];
extern const u8 gText_StarterNameTeddy[];
extern const u8 gText_StarterNameBugsy[];
extern const u8 gText_StarterNameKetut[];
extern const u8 gText_StarterNameHardy[];
extern const u8 gText_StarterNameRin[];
...
extern const u8 gBort_DadsAdvice[];
...
extern const u8 gBort_PlayerUsedVar2[];
