...
extern const u32 gItemIconPal_twixleft[];
extern const u32 gItemIconPal_twixright[];
...
extern const u32 gItemIconPic_choconut[];
extern const u32 gItemIconPal_choconut[];
extern const u32 gItemIconPic_coffeecrisp[];
extern const u32 gItemIconPal_coffeecrisp[];
extern const u32 gItemIconPic_egg[];
extern const u32 gItemIconPal_egg[];
extern const u32 gItemIconPic_deviledegg[];
extern const u32 gItemIconPal_deviledegg[];
extern const u32 gItemIconPic_galaxy[];
extern const u32 gItemIconPal_galaxy[];
extern const u32 gItemIconPic_snappeas[];
extern const u32 gItemIconPal_snappeas[];
extern const u32 gItemIconPic_kale[];
extern const u32 gItemIconPal_kale[];
extern const u32 gItemIconPic_kitkat[];
extern const u32 gItemIconPal_kitkat[];
extern const u32 gItemIconPic_marsbar[];
extern const u32 gItemIconPal_marsbar[];
extern const u32 gItemIconPic_milkaluffee[];
extern const u32 gItemIconPal_milkaluffee[];
extern const u32 gItemIconPic_milkyway[];
extern const u32 gItemIconPal_milkyway[];
extern const u32 gItemIconPic_sambopristur[];
extern const u32 gItemIconPal_sambopristur[];
extern const u32 gItemIconPic_violetcrumble[];
extern const u32 gItemIconPal_violetcrumble[];
extern const u32 gItemIconPic_wunderbar[];
extern const u32 gItemIconPal_wunderbar[];
extern const u32 gItemIconPic_snickers[];
extern const u32 gItemIconPal_snickers[];
extern const u32 gItemIconPic_blackthunder[];
extern const u32 gItemIconPal_blackthunder[];
extern const u32 gItemIconPic_raisin[];
extern const u32 gItemIconPal_raisin[];
