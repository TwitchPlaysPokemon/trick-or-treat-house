...
struct SaveBlock2
{
    ...
    /*0x08*/ u8 playerGender; // MALE, FEMALE, NEITHER
    ...
    /*0x90*/ u16 gameVersionId; // Used to identify the save game, and not allow saves from previous years
...
struct SaveBlock1
{
    ...
    /*0x560*/ struct ItemSlot bagPocket_Candy[BAG_CANDY_COUNT];
