...
extern const struct CompressedSpriteSheet gIntro2BrendanExtendedSpriteSheet[];
extern const struct CompressedSpriteSheet gIntro2MayExtendedSpriteSheet[];
extern const struct CompressedSpriteSheet gIntro2TreekidExtendedSpriteSheet[];
extern const struct CompressedSpriteSheet gIntro2BikeSpriteSheet[];
// extern const struct CompressedSpriteSheet gIntro2BrendanSpriteSheet[];
// extern const struct CompressedSpriteSheet gIntro2MaySpriteSheet[];
// extern const struct CompressedSpriteSheet gIntro2TreekidSpriteSheet[];
