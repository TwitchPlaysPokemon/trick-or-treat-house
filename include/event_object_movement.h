...
#define GROUND_EFFECT_FLAG_FALL_LONG_GRASS_ON_SPAWN  (1 << 23)
#define GROUND_EFFECT_FLAG_FALL_LONG_GRASS_ON_MOVE   (1 << 24)
#define GROUND_EFFECT_FLAG_LAND_IN_FALL_LONG_GRASS   (1 << 25)
